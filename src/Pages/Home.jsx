...
const WORDS = ["Computer Science & Technology Student","Information Security Analyst","Information Security Specialist",
  "Penetration Tester", "Web Developer"];
const TECH_STACK = ["Kali Linux", "Burp Suite", "Wireshark", "Javascript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/aj-0-pius" },
  { icon: Linkedin, link: "https://linkedin.com/in/minhajul-abadin-pius" },
  { icon: Instagram, link: "https://www.instagram.com/aj_0_pius/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Cybersecurity Professionals: We walk the digital shadows, so you can thrive in the light of a safer internet.
                </p>
